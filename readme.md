...
※稀にerror:detectPlayer1またはdetectPlayer2という表示されるが，その場合は再度プログラムを実行すること．
...
「中心を見る」に割り当てられているキーやテンキーなど,一般的なノートパソコンでは使用できないキーもあるため,キーボードレイアウト設定を変更し,Pキーなどに変更する必要がある.
